    ...
    private Handler handler=new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message msg) {
            if(msg.what==1){
                ...
                Toast.makeText(AdminUpdateActivity.this, "修改4成功！", Toast.LENGTH_SHORT).show();
                finish();
            }
                ...
                String newsjson = gson.toJson(new NewsDict(Integer.parseInt(id),title.getText().toString(),text.getText().toString()
                ,publisher.getText().toString(),urls), NewsDict.class);
                upload_news(newsjson);
            }
            return false;
        }
    });
    private void init(){
        ...
        pic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AdminUpdateActivity.this, MultiImageSelectorActivity.class);
                // 是否显示调用相机拍照
...
//                .addFormDataPart("picFiles","pic4",RequestBody.create(MediaType.parse("application/octet-stream"),new File(mSelectPath.get(3))))
    ...
    private void upload_news(String NewsDiceJson){
        OkHttpClient okHttpClient=new OkHttpClient.Builder()
                .callTimeout(6, TimeUnit.MINUTES)
                .connectTimeout(6, TimeUnit.MINUTES)
                .readTimeout(2, TimeUnit.MINUTES)
